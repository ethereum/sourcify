      ...
      <div className="mt-8 flex flex-col text-left">
        <form onSubmit={handleSubmit}>
          <label
            ...
            className="font-bold mb-8 text-xl block"
          >
          ...
          <br />
          <small className="text-ceruleanBlue-800">
            Tap enter &#9166; if search doesn't happen automatically
          </small>
        </form>
      </div>
      {loading && (
        <div className="flex justify-center">
          <svg
            className="animate-spin h-10 w-10 mt-8"
            width="94"
            height="94"
            viewBox="0 0 94 94"
            fill="none"
