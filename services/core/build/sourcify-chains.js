 ...
 * @returns
 */
function buildAlchemyAndCustomRpcURLs(chainSubName, chainName, useOwn = false) {
  const rpcURLs = [];
  if (useOwn) {
    ...
    if (url) {
      ...
      EventManager_1.SourcifyEventManager.trigger("Core.Error", {
...
function replaceInfuraID(infuraURL) {
...
const sourcifyChains = {
  ...
  7001: {
    ...
    monitored: false,
    contractFetchAddress:
      "https://zetachain-athens-3.blockscout.com/" + BLOCKSCOUT_SUFFIX,
    txRegex: getBlockscoutRegex(),
  },
  42262: {
  ...
  101: {
    ...
    monitored: false,
    contractFetchAddress:
      "https://blockscout.development.zetachain.com/" + BLOCKSCOUT_SUFFIX,
    txRegex: getBlockscoutRegex(),
    rpc: ["https://archive.development.zetachain.com/evm"],
  },
};
exports.default = sourcifyChains;
