...
function compareExecutionWithFile(
  commandArguments,
  expectedFileName,
  expectedExitCode
) {
...
describe("main", function () {
  ...
  it("should fail for zipped truffle project with missing sources", function () {
    const testPath = path.join(
      "test",
      "files",
      "truffle-example-missing-source.zip"
    );
  ...
  it("should fail for a metadata file with altered content", function () {
    const testPath = path.join(
      "test",
      "files",
      "metadata-with-content-altered.json"
    );
  ...
  it("should fail for multiple compilationTargets", function () {
    const testPath = path.join(
      "test",
      "files",
      "metadata-multiple-targets.json"
    );
