...
const ValidationService =
  require("../build/ValidationService").ValidationService;
...
describe("ValidationService", function () {
  ...
  describe("#checkPaths", function () {
    it("should succeed for single source file", async function () {
      ...
      const checkedContracts = await validationService.checkPaths(
        paths,
        ignoring
      );
    ...
    it("should ignore invalid paths", async function () {
      ...
      const paths = [Path.join("test", "files", "single"), invalidPath];
      const checkedContracts = await validationService.checkPaths(
        paths,
        ignoring
      );
