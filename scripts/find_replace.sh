...
for VAR_NAME in INFURA_ID ALCHEMY_ID AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY IPFS_SECRET NPM_TOKEN ENS_SECRET PUBLIC_IP LOCAL_IP SESSION_SECRET POSTGRES_USER POSTGRES_PASSWORD
do
