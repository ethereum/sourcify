...
if [ "$CIRCLE_BRANCH" == "staging" ]; then
    TAG="latest"
    INFURA_API_KEY=$INFURA_API_KEY_STAGING
    ...
    ALCHEMY_API_KEY_OPTIMISM=$ALCHEMY_API_KEY_OPTIMISM_STAGING
    ALCHEMY_API_KEY_ARBITRUM=$ALCHEMY_API_KEY_ARBITRUM_STAGING
    ...
    IPFS_GATEWAY=$IPFS_GATEWAY_STAGING
...
if [ "$CIRCLE_BRANCH" == "master" ]; then
    TAG="stable";
    INFURA_API_KEY=$INFURA_API_KEY_MASTER
    ALCHEMY_API_KEY=$ALCHEMY_API_KEY_MASTER
    IPFS_SECRET=$IPFS_SECRET_MASTER
    PUBLIC_IP=$PUBLIC_IP_MASTER
    LOCAL_IP=$LOCAL_IP_MASTER
    SESSION_SECRET=$SESSION_SECRET_MASTER
    ALCHEMY_API_KEY_OPTIMISM=$ALCHEMY_API_KEY_OPTIMISM_MASTER
    ALCHEMY_API_KEY_ARBITRUM=$ALCHEMY_API_KEY_ARBITRUM_MASTER
    ...
    IPFS_GATEWAY=$IPFS_GATEWAY_MASTER
...
for VAR_NAME in INFURA_API_KEY ALCHEMY_API_KEY CF_ACCESS_CLIENT_ID CF_ACCESS_CLIENT_SECRET AWS_S3_ACCESS_KEY_ID AWS_S3_SECRET_ACCESS_KEY IPFS_SECRET NPM_TOKEN PUBLIC_IP LOCAL_IP SESSION_SECRET ALCHEMY_API_KEY_OPTIMISM ALCHEMY_API_KEY_ARBITRUM CHAINSAFE_S3_ACCESS_KEY_ID CHAINSAFE_S3_SECRET_ACCESS_KEY ESTUARY_PINNING_SECRET WEB3_STORAGE_PINNING_SECRET FALLBACK_IPFS_GATEWAY IPFS_GATEWAY CREATE2_CLIENT_TOKENS GRAFANA_HTTP_USER GRAFANA_HTTP_PASS ETHERSCAN_API_KEY ARBISCAN_API_KEY POLYGONSCAN_API_KEY BSCSCAN_API_KEY SNOWTRACE_API_KEY CELOSCAN_API_KEY MOONSCAN_MOONBEAM_API_KEY MOONSCAN_MOONRIVER_API_KEY GNOSISSCAN_API_KEY OPTIMISMSCAN_API_KEY CRONOSCAN_API_KEY BASESCAN_API_KEY
do
