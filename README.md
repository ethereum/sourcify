...
* JSON-formatted file with constructor arguments (only for fully matched contracts using [immutable variables](https://ethereum.stackexchange.com/questions/82240/what-is-the-immutable-keyword-in-solidity)): `/contracts/<MATCH_QUALITY>/<CHAIN_ID>/<CONTRACT_ADDRESS>/constructor-args.txt`
* JSON-formatted file mapping library address placeholders to actual addresses: `/contracts/full_match/<CHAIN_ID>/<CONTRACT_ADDRESS>/library-map.json`
