...
const Verifier: React.FC = () => {
    ...
    */
    ...
    const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        function matchToLink(match: any) {
        ...
        function formatChainAndAddress(chainId: string, address: string) {
            const chain = ID_TO_CHAIN[chainId];
            const label = chain ? chain.label : "Unknown chain";
        ...
        <div className="form-container">
            ...
            <div className="form-container__middle">
                <form className="form" onSubmit={onSubmit}>
                    ...
                    <button type="submit"
                            className={`form__submit-btn ${(!state.address && !state.files.length) ? `form__submit-btn--disabled` : ""}`}
                            disabled={!state.address && !state.files.length}>VERIFY
                    </button>
                </form>
            </div>
        </div>
